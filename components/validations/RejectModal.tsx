        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-5 border-b border-slate-100 pb-3">
              <h3 className="text-lg font-bold font-serif-mct text-[#2D2A56]">
                Rejeter la pièce
              </h3>
              <button
                onClick={onClose}
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs text-slate-500 font-semibold mb-2">
                  Vous rejetez la pièce pour le centre <span className="font-extrabold text-[#2D2A56]">{item.code}</span> ({item.nom}).
                </p>
                ...
                <div className="relative reject-dropdown-container">
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4.5 w-4.5 text-[#2D2A56] transition-transform duration-200 ${isDropdownOpen ? "rotate-180" : ""}`} />
                  </button>
